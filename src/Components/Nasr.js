...
import './Nasr.scss'
import qorqma  from '../assets/images/avloniy.png'
      ...
      <div className='container'>
        <div className='book__inner'>
            <div className='book__img-box'>
                <img className='book__img' src={qorqma}/>
            </div>
            <div className='book__info'>
                <h2 className='book__title'>Qo’rqma</h2>
                <p className='book__author'>Javlon Jovliyev</p>
               ...
               <ul className='book__form-list'>
                   ...
                   <li className='book__form-item'>
                        ...
                        <p className='book__form-price'>6:23 soat</p>
                   </li>
                   <li className='book__form-item'>
                        <i class='bx bxs-card'></i>
                        <p className='book__form-title'>Elektron</p>
                        <p className='book__form-price'>pdf, epub</p>
                   </li>
               </ul>
        ...
        <div>
            ...
            <div className='book__inner-box'>
                <div className='book__quotes'>
                        <i class='bx bxs-quote-alt-left quotes'></i>
